      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Smart Pricing Dashboard</h1>
              <p className="text-slate-600">Advanced pricing optimization and analytics platform</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div className="metric-block">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full">+2.1%</span>
                </div>
                <h3 className="text-sm font-medium text-slate-600 mb-1">Average Margin</h3>
              ...
              <div className="metric-block">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-medium text-purple-600 bg-purple-50 px-2 py-1 rounded-full">+8.3%</span>
                </div>
                <h3 className="text-sm font-medium text-slate-600 mb-1">Orders Processed</h3>
                <p className="text-2xl font-bold text-slate-900">{stats.ordersProcessed.toLocaleString()}</p>
              ...
              <div className="metric-block">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-medium text-orange-600 bg-orange-50 px-2 py-1 rounded-full">+1.2%</span>
                </div>
                <h3 className="text-sm font-medium text-slate-600 mb-1">Shipping Accuracy</h3>
                <p className="text-2xl font-bold text-slate-900">{stats.shippingAccuracy}%</p>
